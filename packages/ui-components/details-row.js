...
export const DetailsRow = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: cn(Styles['details-row'], Styles.title, className, {
            [Styles.steel]: !available,
        }) }, attributes),
        React.createElement(Icon, { className: cn(Styles['details-row'], {
