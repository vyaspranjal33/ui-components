...
export var Actions = function (_a) {
    ...
    return (React.createElement("div", __assign({ className: cn('actions', className) }, attributes), vertical ? (React.createElement(DropdownButton, { gear: true, icon: "ellipsis-vertical" }, actions)) : (React.createElement(Fragment, null,
