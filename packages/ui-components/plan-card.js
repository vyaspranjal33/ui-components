...
function renderPackageDetails(packageDetails, selectedPackage) {
    return packageDetails.map(p => (React.createElement("div", { className: cn(Styles['packages-container']) },
        React.createElement(Card, { className: cn(Styles['card-padding']), inline: true, thin: true, title: "" },
            React.createElement("div", { className: cn(Styles.col1, Styles.small) },
                React.createElement("h3", { className: cn(Styles['package-name']) }, p.name),
            ...
            React.createElement("div", { className: cn(Styles.small, Styles['plan-status']) },
                ...
                p.name === selectedPackage ? ('Your Current Plan') : (React.createElement("p", { className: cn(Styles.price) },
                    "$",
                    p.price,
                    "/mo*",
                    React.createElement(Button, { className: cn(Styles['select-btn']), type: "secondary", onClick: null, small: true }, "Select"))))),
...
export const PlanCard = ({ planTitle, recommended, selectedPackage, packageDetails, planDetails, }) => (React.createElement("div", { className: cn(Styles['plan-card']) },
    React.createElement("div", { className: cn(Styles.col1) },
        React.createElement("h2", null,
            planTitle,
            "\u00A0\u00A0\u00A0",
            recommended ? (React.createElement(Badge, { className: cn(Styles['plan-card']), gradient: true }, "RECOMMENDED")) : null),
