...
var EmailCardSendTime = function (_a) {
    ...
    return (React.createElement("div", __assign({ className: cn('email-card-send-time', className, {
            'has-value': !!value,
        }) }, attributes),
...
var EmailCardContent = function (_a) {
    ...
    return (React.createElement("div", __assign({ className: cn('email-card-content', className) }, attributes), thumbnailUrl ? (React.createElement("a", { href: "#" },
