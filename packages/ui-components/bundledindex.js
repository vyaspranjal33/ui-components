...
const Badge = ({ children, color, content }) => (React__default.createElement("span", { className: classNames('badge', color) }, children || content));
Badge.defaultProps = {
    children: 0,
    color: '',
};
...
const Breadcrumb = ({ children, withoutTrailingSlash, }) => (React__default.createElement("ol", { className: "breadcrumb" },
    mapper(children),
