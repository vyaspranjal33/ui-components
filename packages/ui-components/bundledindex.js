...
class CenterModal extends React.Component {
    ...
    render() {
        ...
        return reactDom.createPortal(React__default.createElement(React.Fragment, null,
            ...
            React__default.createElement("div", { className: classNames('modal-mask', { 'is-visible': this.props.open }), onClick: this.props.onClose })), this.props.modalContainer);
    }
}
...
class ConfirmationModal extends React.Component {
    ...
    render() {
        return reactDom.createPortal(React__default.createElement("div", { className: classNames('sg-modal', { 'is-visible': this.props.isOpen }) },
            React__default.createElement("div", { className: "conf-alert sg-modal-content" },
                React__default.createElement("h2", { className: classNames('conf-alert-header', { 'conf-alert-header-with-icon': !!this.props.iconType }) },
                    !!this.props.iconType &&
                ...
                React__default.createElement("div", { className: "conf-alert-actions" }, evaluateRenderProp$1(this.props.renderActions)))), this.props.modalContainer);
    }
}
...
const EmailCardSendTime = ({ value, renderSendTimeLink, alert = '' }) => {
    return (React__default.createElement("div", { className: classNames('email-card-send-time', { 'has-value': !!value }) },
...
const EmailCardDetails = ({ details }) => {
    ...
    return (React__default.createElement("div", { className: "email-card-details" },
        React__default.createElement("table", null,
            React__default.createElement("tbody", null, rows))));
};
const EmailCardContent = ({ thumbnailUrl, onContentEditClick }) => (React__default.createElement("div", { className: "email-card-content" }, thumbnailUrl ?
...
const EmailCardAddButton = ({ onClick }) => {
    return (React__default.createElement("div", { className: "btn-list email-card-add" },
...
class EmailCard extends React__default.Component {
    render() {
        ...
        return (React__default.createElement("div", { className: classNames('email-card-wrap', {
