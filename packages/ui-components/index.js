...
var AccordionPanelTitle = function (_a) {
    var text = _a.text;
    return typeof text === 'string' ? React__default.createElement("h2", null, text) : React__default.createElement(React.Fragment, null, text);
};
var AccordionPanelDescription = function (_a) {
    var text = _a.text;
    return typeof text === 'string' ? React__default.createElement("p", null, text) : React__default.createElement(React.Fragment, null, text);
};
...
var AccordionPanel = function (_a) {
    ...
    return (React__default.createElement("div", { className: classNames('accordion-panel', className, {
            'has-child': noPadding,
            'is-visible': isOpen,
        }) },
        React__default.createElement("div", { className: "accordion-title", onClick: onClick }, title),
        React__default.createElement(AnimateHeight, { duration: 500, height: isOpen ? 'auto' : 0 },
...
var Actions = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('actions', className) }, attributes), vertical ?
        React__default.createElement(DropdownButton, { gear: true, icon: "ellipsis-vertical" }, actions)
        :
...
var mapper = function (children) { return (map$1(children, function (child, i) { return (child && React__default.createElement("li", { key: child.props.to || child.props.href },
...
var CenterModal = /** @class */ (function (_super) {
    ...
    CenterModal.prototype.render = function () {
        ...
        return reactDom.createPortal(React__default.createElement(React.Fragment, null,
            React__default.createElement("div", __assign({ className: classNames('center-modal', className, { 'is-visible': open, 'is-large': large }) }, attributes),
                hasX &&
                    (React__default.createElement("i", { className: "sg-icon sg-icon-x", "data-role": "close-center-modal", onClick: onClose })),
                renderHeader && React__default.createElement("h1", null, evaluateRenderProp(renderHeader)),
                evaluateRenderProp(renderBody),
                renderFooter &&
                    (React__default.createElement("div", { className: "modal-footer" }, evaluateRenderProp(renderFooter)))),
    ...
    ConfirmationModal.prototype.render = function () {
        ...
        return reactDom.createPortal(React__default.createElement("div", __assign({ className: classNames('sg-modal', className, { 'is-visible': isOpen }) }, attributes),
            React__default.createElement("div", { className: "conf-alert sg-modal-content" },
                React__default.createElement("h2", { className: classNames('conf-alert-header', { 'conf-alert-header-with-icon': !!iconType }) },
                    !!iconType &&
                        React__default.createElement(Icon, { type: iconType }),
...
var EmailCardStat = function (_a) {
    ...
    return (React__default.createElement("div", { className: commonClass, key: statistic.label },
        React__default.createElement("p", { className: classNames('stat', specificClass) }, (statistic.amount || parseInt(statistic.amount, 10) === 0) ? statistic.amount : NO_STATS_CHAR),
...
var EmailCardSendTime = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('email-card-send-time', className, { 'has-value': !!value }) }, attributes),
...
var EmailCardContent = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('email-card-content', className) }, attributes), thumbnailUrl ?
...
var EmailCard = /** @class */ (function (_super) {
    ...
    EmailCard.prototype.render = function () {
        ...
        return (React__default.createElement("div", __assign({ className: classNames('email-card-wrap', className, {
            ...
            statistics &&
                React__default.createElement(Statistics, { commonClass: "email-stats" },
