...
var AccordionPanelDescription = function (_a) {
    var text = _a.text, style = _a.style, className = _a.className, attributes = __rest(_a, ["text", "style", "className"]);
    return (React__default.createElement("p", __assign({ style: style, className: className }, attributes), text));
};
...
var Icon = function (_a) {
    ...
    return (React__default.createElement("i", __assign({ className: classNames('sg-icon', "sg-icon-" + type, (_b = {}, _b[className] = !!className, _b["is-size-" + size] = size, _b)), onClick: handleClick, style: onDark ? lightStyle : null }, attributes)));
    var _b;
};
Icon.defaultProps = {
    className: '',
...
var AccordionPanelIcon = function (_a) {
    var iconType = _a.iconType;
    return React__default.createElement(Icon, { className: "accordion-icon", type: iconType });
};

var AccordionPanelTitle = function (_a) {
    var text = _a.text, style = _a.style, className = _a.className, attributes = __rest(_a, ["text", "style", "className"]);
    return (React__default.createElement("h2", __assign({ className: className, style: style }, attributes), text));
};
...
var AccordionPanelSFC = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('accordion-panel', className, {
            'has-child': noPadding,
            'is-visible': open,
        }) }, attributes),
        React__default.createElement("div", { className: "accordion-title", onClick: onClick }, title),
        React__default.createElement(AnimateHeight, { duration: 500, height: open ? 'auto' : 0 },
            React__default.createElement("div", { className: "accordion-content", style: { display: 'block' } }, children))));
};
var AccordionPanel = /** @class */ (function (_super) {
    ...
    AccordionPanel.prototype.render = function () {
        return (React__default.createElement(AccordionPanelSFC, __assign({}, this.props, { open: this.state.open, onClick: this.onAccordionPanelClick }), this.props.children));
    };
...
var Accordion = function (_a) {
    ...
    return (React__default.createElement("div", { className: classNames('accordion-wrapper', className, {
...
var Badge = function (_a) {
    ...
    return (React__default.createElement("span", __assign({ className: classNames('badge', className, color) }, attributes), children || content));
};
Badge.defaultProps = {
    children: 0,
    className: '',
...
var Loader = function (_a) {
    ...
    return (React__default.createElement("svg", __assign({ className: classNames('sg-loader', className, {
...
var Button = function (props) {
    ...
    return (React__default.createElement(Buttonized, __assign({}, props),
        React__default.createElement("button", { type: btnType }, props.children)));
};
var Buttonized = function (_a) {
    ...
    return React__default.cloneElement(children, __assign({ className: classNames('btn', "btn-" + type, className, {
            'btn-on-dark': onDark,
            'btn-small': small,
            'has-badge': hasBadge,
...
var DropdownButton = /** @class */ (function (_super) {
    ...
    DropdownButton.prototype.render = function () {
        ...
        return (React__default.createElement("div", { className: "btn-list" },
            React__default.createElement("div", __assign({ className: classNames('btn', 'btn-dropdown', 'dropdown', "btn-" + buttonType, className, {
                ...
                gear ? React__default.createElement(Icon, { type: icon || 'gear' }) : label,
...
var Actions = function (_a) {
    ...
    var actions = React__default.Children.map(children, function (action) {
        return React__default.cloneElement(action, {
            showTitle: vertical,
        });
    });
    return (React__default.createElement("div", __assign({ className: classNames('actions', className) }, attributes), vertical ? (React__default.createElement(DropdownButton, { gear: true, icon: "ellipsis-vertical" }, actions)) : (React__default.createElement(React.Fragment, null,
...
var ActionsCell = function (_a) {
    ...
    return (React__default.createElement("td", __assign({ className: classNames('actions', className) }, attributes),
        React__default.createElement(Icon, { type: "ellipsis" }),
        React__default.createElement("div", { className: "action-icons" }, children)));
};
var Action = function (_a) {
    ...
    return (React__default.createElement("span", __assign({}, tooltipAttributes, { onClick: handleClick }, attributes),
...
var Alert = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('alert', "alert-" + type, className, {
            'alert-inline': inline,
...
var mapper = function (children) {
    return map$1(children, function (child, i) {
        return child && (React__default.createElement("li", { key: child.props.to || child.props.href },
...
var Breadcrumb = function (_a) {
    ...
    return (React__default.createElement("ol", __assign({ className: classNames('breadcrumb', className) }, attributes),
        mapper(children),
...
var ButtonList = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('btn-list', className) }, attributes), map$2(children, function (button) {
...
var Card = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('card', className, {
            'is-centered': centered,
            'is-inline': inline,
...
var ModuleCard = function (_a) {
    ...
    return (React__default.createElement(Card, __assign({ centered: true, thin: true, className: classNames('is-module', className) }, attributes),
        React__default.createElement("p", null,
            React__default.createElement(Icon, { type: iconTypes[type] }),
            titles[type])));
};

var SplitCardSeparator = function (_a) {
    var label = _a.label, className = _a.className, attributes = __rest(_a, ["label", "className"]);
    return (React__default.createElement("hr", __assign({ className: classNames(className, { 'has-label': label }), "data-label": label }, attributes)));
};
var SplitCard = function (_a) {
    var children = _a.children, className = _a.className, attributes = __rest(_a, ["children", "className"]);
    return (React__default.createElement(Card, __assign({ thin: true, className: classNames('is-split', className) }, attributes),
        React__default.createElement("div", { className: "split-content" }, children)));
};
...
function A(a){for(var b=arguments.length-1,c="https://reactjs.org/docs/error-decoder.html?invariant="+a,d=0;d<b;d++)c+="&args[]="+encodeURIComponent(arguments[d+1]);invariant_1(!1,"Minified React error #"+a+"; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ",c);}React__default?void 0:A("227");
...
B._caughtError;B._caughtError=null;B._hasCaughtError=!1;return a}A("198");}};function ka(){if(B._hasRethrowError){var a=B._rethrowError;B._rethrowError=null;B._hasRethrowError=!1;throw a;}}var la=null; var ma={};
function na(){if(la)for(var a in ma){var b=ma[a],c=la.indexOf(a);-1<c?void 0:A("96",a);if(!oa[c]){b.extractEvents?void 0:A("97",a);oa[c]=b;c=b.eventTypes;for(var d in c){var e=void 0;var f=c[d],g=b,h=d;pa.hasOwnProperty(h)?A("99",h):void 0;pa[h]=f;var k=f.phasedRegistrationNames;if(k){for(e in k)k.hasOwnProperty(e)&&qa(k[e],g,h);e=!0;}else f.registrationName?(qa(f.registrationName,g,h), e=!0):e=!1;e?void 0:A("98",d,a);}}}}
function qa(a,b,c){ra[a]?A("100",a):void 0;ra[a]=b;sa[a]=b.eventTypes[c].dependencies;}var oa=[]; var pa={}; var ra={}; var sa={};function ta(a){la?A("101"):void 0;la=Array.prototype.slice.call(a);na();}function ua(a){var b=!1,c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];ma.hasOwnProperty(c)&&ma[c]===d||(ma[c]?A("102",c):void 0, ma[c]=d, b=!0);}b&&na();}
...
var wa=null;
var xa=null;
var ya=null;function za(a,b,c,d){b=a.type||"unknown-event";a.currentTarget=ya(d);B.invokeGuardedCallbackAndCatchFirstError(b,c,void 0,a);a.currentTarget=null;}
...
return c}function Ia(a,b){null!==a&&(Ca=Aa(Ca,a));a=Ca;Ca=null;a&&(b?Ba(a,Ea):Ba(a,Fa), Ca?A("95"):void 0, B.rethrowCaughtError());}function Ja(a,b,c,d){for(var e=null,f=0;f<oa.length;f++){var g=oa[f];g&&(g=g.extractEvents(a,b,c,d))&&(e=Aa(e,g));}Ia(e,!1);}var Ka={injection:Ga,getListener:Ha,runEventsInBatch:Ia,runExtractedEventsInBatch:Ja}; var La=Math.random().toString(36).slice(2); var C="__reactInternalInstance$"+La; var Ma="__reactEventHandlers$"+La;
...
objectAssign(H.prototype,{preventDefault:function(){this.defaultPrevented=!0;var a=this.nativeEvent;a&&(a.preventDefault?a.preventDefault():"unknown"!==typeof a.returnValue&&(a.returnValue=!1), this.isDefaultPrevented=emptyFunction_1.thatReturnsTrue);},stopPropagation:function(){var a=this.nativeEvent;a&&(a.stopPropagation?a.stopPropagation():"unknown"!==typeof a.cancelBubble&&(a.cancelBubble=!0), this.isPropagationStopped=emptyFunction_1.thatReturnsTrue);},persist:function(){this.isPersistent=emptyFunction_1.thatReturnsTrue;},isPersistent:emptyFunction_1.thatReturnsFalse,
destructor:function(){var a=this.constructor.Interface,b;for(b in a)this[b]=null;for(a=0;a<ob.length;a++)this[ob[a]]=null;}});H.Interface=pb;H.extend=function(a){function b(){}function c(){return d.apply(this,arguments)}var d=this;b.prototype=d.prototype;var e=new b;objectAssign(e,c.prototype);c.prototype=e;c.prototype.constructor=c;c.Interface=objectAssign({},d.Interface,a);c.extend=d.extend;qb(c);return c};qb(H);
function rb(a,b,c,d){if(this.eventPool.length){var e=this.eventPool.pop();this.call(e,a,b,c,d);return e}return new this(a,b,c,d)}function sb(a){a instanceof this?void 0:A("223");a.destructor();10>this.eventPool.length&&this.eventPool.push(a);}function qb(a){a.eventPool=[];a.getPooled=rb;a.release=sb;}var tb=H.extend({data:null}); var ub=H.extend({data:null}); var vb=[9,13,27,32]; var wb=ExecutionEnvironment_1.canUseDOM&&"CompositionEvent"in window; var xb=null;ExecutionEnvironment_1.canUseDOM&&"documentMode"in document&&(xb=document.documentMode);
...
var Lb=null;
var Mb=null;function Nb(a){if(a=xa(a)){Jb&&"function"===typeof Jb.restoreControlledState?void 0:A("194");var b=wa(a.stateNode);Jb.restoreControlledState(a.stateNode,a.type,b);}}function Ob(a){Lb?Mb?Mb.push(a):Mb=[a]:Lb=a;}
...
var ec=React__default.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner;
var I="function"===typeof Symbol&&Symbol.for;
var fc=I?Symbol.for("react.element"):60103;
var gc=I?Symbol.for("react.portal"):60106;
var hc=I?Symbol.for("react.fragment"):60107;
var ic=I?Symbol.for("react.strict_mode"):60108;
var jc=I?Symbol.for("react.profiler"):60114;
var mc=I?Symbol.for("react.provider"):60109;
var nc=I?Symbol.for("react.context"):60110;
var oc=I?Symbol.for("react.async_mode"):60111;
var pc=I?Symbol.for("react.forward_ref"):60112;
var qc=I?Symbol.for("react.timeout"):
60113;
var rc="function"===typeof Symbol&&Symbol.iterator;function sc(a){if(null===a||"undefined"===typeof a)return null;a=rc&&a[rc]||a["@@iterator"];return"function"===typeof a?a:null}
...
var xc={};
var yc={};function zc(a){if(yc.hasOwnProperty(a))return!0;if(xc.hasOwnProperty(a))return!1;if(wc.test(a))return yc[a]=!0;xc[a]=!0;return!1}
...
var ad=H.extend({view:null,
detail:null});
var bd={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function cd(a){var b=this.nativeEvent;return b.getModifierState?b.getModifierState(a):(a=bd[a])?!!b[a]:!1}function dd(){return cd}
var ed=ad.extend({screenX:null,screenY:null,clientX:null,clientY:null,pageX:null,pageY:null,ctrlKey:null,shiftKey:null,altKey:null,metaKey:null,getModifierState:dd,button:null,buttons:null,relatedTarget:function(a){return a.relatedTarget||(a.fromElement===a.srcElement?a.toElement:a.fromElement)}});
var fd=ed.extend({pointerId:null,width:null,height:null,pressure:null,tiltX:null,tiltY:null,pointerType:null,isPrimary:null});
var gd={mouseEnter:{registrationName:"onMouseEnter",dependencies:["mouseout","mouseover"]},
...
var hd={eventTypes:gd,extractEvents:function(a,b,c,d){var e="mouseover"===a||"pointerover"===a,f="mouseout"===a||"pointerout"===a;if(e&&(c.relatedTarget||c.fromElement)||!f&&!e)return null;e=d.window===d?d:(e=d.ownerDocument)?e.defaultView||
...
function md(a){a=kd(a);if(!a)return null;for(var b=a;;){if(5===b.tag||6===b.tag)return b;if(b.child&&4!==b.tag)b.child.return=b, b=b.child;else{if(b===a)break;for(;!b.sibling;){if(!b.return||b.return===a)return null;b=b.return;}b.sibling.return=b.return;b=b.sibling;}}return null}var nd=H.extend({animationName:null,elapsedTime:null,pseudoElement:null}); var od=H.extend({clipboardData:function(a){return"clipboardData"in a?a.clipboardData:window.clipboardData}}); var pd=ad.extend({relatedTarget:null});
...
var sd={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",
116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"};
var td=ad.extend({key:function(a){if(a.key){var b=rd[a.key]||a.key;if("Unidentified"!==b)return b}return"keypress"===a.type?(a=qd(a), 13===a?"Enter":String.fromCharCode(a)):"keydown"===a.type||"keyup"===a.type?sd[a.keyCode]||"Unidentified":""},location:null,ctrlKey:null,shiftKey:null,altKey:null,metaKey:null,repeat:null,locale:null,getModifierState:dd,charCode:function(a){return"keypress"===
a.type?qd(a):0},keyCode:function(a){return"keydown"===a.type||"keyup"===a.type?a.keyCode:0},which:function(a){return"keypress"===a.type?qd(a):"keydown"===a.type||"keyup"===a.type?a.keyCode:0}});
var ud=ed.extend({dataTransfer:null});
var vd=ad.extend({touches:null,targetTouches:null,changedTouches:null,altKey:null,metaKey:null,ctrlKey:null,shiftKey:null,getModifierState:dd});
var wd=H.extend({propertyName:null,elapsedTime:null,pseudoElement:null});
var xd=ed.extend({deltaX:function(a){return"deltaX"in a?a.deltaX:"wheelDeltaX"in
...
var yd=[["abort","abort"],[fb,"animationEnd"],[gb,"animationIteration"],[hb,"animationStart"],["canplay","canPlay"],["canplaythrough","canPlayThrough"],["drag","drag"],["dragenter","dragEnter"],["dragexit","dragExit"],["dragleave","dragLeave"],["dragover","dragOver"],["durationchange","durationChange"],["emptied","emptied"],["encrypted","encrypted"],
...
var zd={};
var Ad={};function Bd(a,b){var c=a[0];a=a[1];var d="on"+(a[0].toUpperCase()+a.slice(1));b={phasedRegistrationNames:{bubbled:d,captured:d+"Capture"},dependencies:[c],isInteractive:b};zd[a]=b;Ad[c]=b;}
...
var Md={get _enabled(){return Gd},setEnabled:Id,isEnabled:function(){return Gd},trapBubbledEvent:L,trapCapturedEvent:Ld,dispatchEvent:Kd};
var Nd={};
var Od=0;
var Pd="_reactListenersID"+(""+Math.random()).slice(2);function Qd(a){Object.prototype.hasOwnProperty.call(a,Pd)||(a[Pd]=Od++, Nd[a[Pd]]={});return Nd[a[Pd]]}function Rd(a){for(;a&&a.firstChild;)a=a.firstChild;return a}
...
var Vd={select:{phasedRegistrationNames:{bubbled:"onSelect",captured:"onSelectCapture"},dependencies:"blur contextmenu focus keydown keyup mousedown mouseup selectionchange".split(" ")}};
var Wd=null;
var Xd=null;
var Yd=null;
var Zd=!1;
function $d(a,b){if(Zd||null==Wd||Wd!==getActiveElement_1())return null;var c=Wd;"selectionStart"in c&&Td(c)?c={start:c.selectionStart,end:c.selectionEnd}:window.getSelection?(c=window.getSelection(), c={anchorNode:c.anchorNode,anchorOffset:c.anchorOffset,focusNode:c.focusNode,focusOffset:c.focusOffset}):c=void 0;return Yd&&shallowEqual_1(Yd,c)?null:(Yd=c, a=H.getPooled(Vd.select,Xd,a,b), a.type="select", a.target=Wd, Ya(a), a)}
...
be="object"===typeof performance&&"function"===typeof performance.now?function(){return performance.now()}:function(){return Date.now()};var ce=void 0; var de=void 0;
...
callbackId:b,timeoutTime:c});ge[b]=!0;je||(je=!0, requestAnimationFrame(qe));return b};de=function(a){delete ge[a];};}else{var re=0,se={};ce=function(a){var b=re++,c=setTimeout(function(){a({timeRemaining:function(){return Infinity},didTimeout:!1});});se[b]=c;return b};de=function(a){var b=se[a];delete se[a];clearTimeout(b);};}function te(a){var b="";React__default.Children.forEach(a,function(a){null==a||"string"!==typeof a&&"number"!==typeof a||(b+=a);});return b}
...
var Ie=["Webkit","ms","Moz","O"];Object.keys(He).forEach(function(a){Ie.forEach(function(b){b=b+a.charAt(0).toUpperCase()+a.substring(1);He[b]=He[a];});});
...
c=c.querySelectorAll("input[name="+JSON.stringify(""+b)+'][type="radio"]');for(b=0;b<c.length;b++){var d=c[b];if(d!==a&&d.form===a.form){var e=Pa(d);e?void 0:A("90");dc(d);Jc(d,e);}}}break;case "textarea":ze(a,c);break;case "select":b=c.value, null!=b&&ve(a,!!c.multiple,b,!1);}}};
var Xe=null;
var Ye=null;function Ze(a,b){switch(a){case "button":case "input":case "select":case "textarea":return!!b.autoFocus}return!1}
function $e(a,b){return"textarea"===a||"string"===typeof b.children||"number"===typeof b.children||"object"===typeof b.dangerouslySetInnerHTML&&null!==b.dangerouslySetInnerHTML&&"string"===typeof b.dangerouslySetInnerHTML.__html}var af=be; var bf=ce; var cf=de;function df(a){for(a=a.nextSibling;a&&1!==a.nodeType&&3!==a.nodeType;)a=a.nextSibling;return a}function ef(a){for(a=a.firstChild;a&&1!==a.nodeType&&3!==a.nodeType;)a=a.nextSibling;return a}var ff=[]; var gf=-1;function hf(a){return{current:a}}
function M(a){0>gf||(a.current=ff[gf], ff[gf]=null, gf--);}function N(a,b){gf++;ff[gf]=a.current;a.current=b;}var jf=hf(emptyObject_1); var O=hf(!1); var kf=emptyObject_1;function lf(a){return mf(a)?kf:jf.current}
...
function qf(a,b,c){jf.current!==emptyObject_1?A("168"):void 0;N(jf,b,a);N(O,c,a);}function rf(a,b){var c=a.stateNode,d=a.type.childContextTypes;if("function"!==typeof c.getChildContext)return b;c=c.getChildContext();for(var e in c)e in d?void 0:A("108",tc(a)||"Unknown",e);return objectAssign({},b,c)}function sf(a){if(!mf(a))return!1;var b=a.stateNode;b=b&&b.__reactInternalMemoizedMergedChildContext||emptyObject_1;kf=jf.current;N(jf,b,a);N(O,O.current,a);return!0}
...
function Af(a,b,c){b=new uf(3,null,null,b?3:0);a={current:b,containerInfo:a,pendingChildren:null,earliestPendingTime:0,latestPendingTime:0,earliestSuspendedTime:0,latestSuspendedTime:0,latestPingedTime:0,pendingCommitExpirationTime:0,finishedWork:null,context:null,pendingContext:null,hydrate:c,remainingExpirationTime:0,firstBatch:null,nextScheduledRoot:null};return b.stateNode=a}var Bf=null; var Cf=null;function Df(a){return function(b){try{return a(b)}catch(c){}}}
...
function Tf(a,b){return{value:a,source:b,stack:vc(b)}}var Uf=hf(null); var Vf=hf(null); var Wf=hf(0);function Xf(a){var b=a.type._context;N(Wf,b._changedBits,a);N(Vf,b._currentValue,a);N(Uf,a,a);b._currentValue=a.pendingProps.value;b._changedBits=a.stateNode;}function Yf(a){var b=Wf.current,c=Vf.current;M(Uf,a);M(Vf,a);M(Wf,a);a=a.type._context;a._currentValue=c;a._changedBits=b;}var Zf={}; var $f=hf(Zf); var ag=hf(Zf); var bg=hf(Zf);function cg(a){a===Zf?A("174"):void 0;return a}
...
a, a=d):(c(a,d), d=yf(f,a.mode,h), d.return=a, a=d), g(a);if(pg(f))return Hd(a,d,f,h);if(sc(f))return E(a,d,f,h);k&&rg(a,f);if("undefined"===typeof f)switch(a.tag){case 2:case 1:h=a.type, A("152",h.displayName||h.name||"Component");}return c(a,d)}}var tg=sg(!0); var ug=sg(!1); var vg=null; var wg=null; var xg=!1;function yg(a,b){var c=new uf(5,null,null,0);c.type="DELETED";c.stateNode=b;c.return=a;c.effectTag=8;null!==a.lastEffect?(a.lastEffect.nextEffect=c, a.lastEffect=c):a.firstEffect=a.lastEffect=c;}
...
R(a,b);break a}c=f.children;c=c(e);b.effectTag|=1;Q(a,b,c);a=b.child;}else a=R(a,b);return a;default:A("156");}}function Lg(a){a.effectTag|=4;}var Pg=void 0; var Qg=void 0; var Rg=void 0;Pg=function(){};Qg=function(a,b,c){(b.updateQueue=c)&&Lg(b);};Rg=function(a,b,c,d){c!==d&&Lg(b);};
...
function fh(a){switch(a.tag){case 2:of(a);var b=a.effectTag;return b&1024?(a.effectTag=b&-1025|64, a):null;case 3:return eg(a), pf(a), b=a.effectTag, b&1024?(a.effectTag=b&-1025|64, a):null;case 5:return fg(a), null;case 16:return b=a.effectTag, b&1024?(a.effectTag=b&-1025|64, a):null;case 4:return eg(a), null;case 13:return Yf(a), null;default:return null}}var gh=af(); var hh=2; var ih=gh; var jh=0; var kh=0; var lh=!1; var S=null; var mh=null; var T=0; var nh=-1; var oh=!1; var U=null; var ph=!1; var qh=!1; var dh=null;
...
function Dh(a){var b=kh;kh=2+25*(((ig()-2+500)/25|0)+1);try{return a()}finally{kh=b;}}function Eh(a,b,c,d,e){var f=kh;kh=1;try{return a(b,c,d,e)}finally{kh=f;}}var Fh=null; var V=null; var Gh=0; var Hh=-1; var W=!1; var X=null; var Y=0; var Ah=0; var Ih=!1; var Jh=!1; var Kh=null; var Lh=null; var Z=!1; var Mh=!1; var zh=!1; var Nh=null; var Ch=1E3; var Bh=0; var Oh=1;function Ph(a){if(0!==Gh){if(a>Gh)return;cf(Hh);}var b=af()-gh;Gh=a;Hh=bf(Qh,{timeout:10*(a-2)-b});}
...
var vi={default:qi};
var wi=vi&&qi||vi;var reactDom_production_min=wi.default?wi.default:wi;
...
var CenterModal = /** @class */ (function (_super) {
    ...
    CenterModal.prototype.render = function () {
        ...
        return reactDom.createPortal(React__default.createElement(React.Fragment, null,
            React__default.createElement("div", __assign({ className: classNames('center-modal', className, {
                    'is-large': large,
                    'is-visible': open,
                }) }, attributes),
                hasX && (React__default.createElement("i", { className: "sg-icon sg-icon-x", "data-role": "close-center-modal", onClick: onClose })),
                renderHeader && React__default.createElement("h1", null, evaluateRenderProp(renderHeader)),
                evaluateRenderProp(renderBody),
                renderFooter && (React__default.createElement("div", { className: "modal-footer" }, evaluateRenderProp(renderFooter)))),
            React__default.createElement("div", { className: classNames('modal-mask', { 'is-visible': open }), onClick: onClose })), modalContainer);
    };
...
var Checkbox = function (_a) {
    ...
    return (React__default.createElement("div", { className: "input-checkbox-wrap" },
        React__default.createElement("input", __assign({ checked: checked, disabled: disabled, id: id, onChange: onChange, type: "checkbox", value: value }, attributes)),
...
var ConfirmationModal = /** @class */ (function (_super) {
    ...
    ConfirmationModal.prototype.render = function () {
        ...
        return reactDom.createPortal(React__default.createElement("div", __assign({ className: classNames('sg-modal', className, { 'is-visible': isOpen }) }, attributes),
            React__default.createElement("div", { className: "conf-alert sg-modal-content" },
                React__default.createElement("h2", { className: classNames('conf-alert-header', {
                        'conf-alert-header-with-icon': !!iconType,
                    }) },
                    !!iconType && React__default.createElement(Icon, { type: iconType }),
                    evaluateRenderProp$1(renderHeader)),
                React__default.createElement("div", { className: "conf-alert-body" },
                    React__default.createElement("p", { className: "conf-alert-text" }, evaluateRenderProp$1(renderBody))),
                React__default.createElement("div", { className: "conf-alert-actions" }, evaluateRenderProp$1(renderActions)))), modalContainer);
    };
...
var Divider = function (_a) {
    ...
    return (React__default.createElement("hr", __assign({ className: classNames(className, {
            'has-label': !!label,
            'is-thin': thin,
...
var Dropzone = function (_a) {
    ...
    return (React__default.createElement("section", __assign({ className: classNames('dropzone', className, {
...
var NO_STATS_CHAR = '—';
var EmailCardStat = function (_a) {
    var statistic = _a.statistic, specificClass = _a.specificClass, commonClass = _a.commonClass;
    return (React__default.createElement("div", { className: commonClass, key: statistic.label },
        React__default.createElement("p", { className: classNames('stat', specificClass) }, statistic.amount || parseInt(statistic.amount, 10) === 0
            ? statistic.amount
            : NO_STATS_CHAR),
        React__default.createElement("p", { className: "label" }, statistic.label)));
};
var Statistics = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('email-card-stats', className) }, attributes), React__default.Children.map(children, function (child) {
        return React__default.cloneElement(child, { commonClass: commonClass });
    })));
};
...
var EmailCardSendTime = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('email-card-send-time', className, {
            'has-value': !!value,
        }) }, attributes),
    ...
    var rows = details &&
        details.map(function (detail) {
            return (React__default.createElement("tr", { key: detail.label },
                React__default.createElement("td", { className: "label" }, detail.label),
                React__default.createElement("td", null, (detail.renderEditDetailLink &&
                    detail.renderEditDetailLink(detail.value)) ||
                    detail.value)));
        });
    return (React__default.createElement("div", __assign({ className: classNames('email-card-details', className) }, attributes),
...
var EmailCardContent = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('email-card-content', className) }, attributes), thumbnailUrl ? (React__default.createElement("a", { href: "#" },
        React__default.createElement("img", { src: thumbnailUrl, onClick: onContentEditClick }),
        React__default.createElement("span", { className: "email-card-content-edit" },
            React__default.createElement(Icon, { type: "pencil" }),
            "Edit"))) : (React__default.createElement(Button, { type: "secondary", onClick: onContentEditClick }, "Add Email Content"))));
};
var EmailCardAddButton = function (_a) {
    var onClick = _a.onClick, className = _a.className, attributes = __rest(_a, ["onClick", "className"]);
    return (React__default.createElement("div", __assign({ className: classNames('btn-list', 'email-card-add', className) }, attributes),
...
var EmailCard = /** @class */ (function (_super) {
    ...
    EmailCard.prototype.render = function () {
        ...
        return (React__default.createElement("div", __assign({ className: classNames('email-card-wrap', className, {
                'has-alert': !!renderAlert,
                'is-editable': editable,
                'is-live': live,
                'is-paused': paused,
            }) }, attributes),
            React__default.createElement(EmailCardSendTime, { value: sendTimeValue, renderSendTimeLink: renderSendTimeLink, alert: alertEl }),
            statistics && (React__default.createElement(Statistics, { commonClass: "email-stats" },
                React__default.createElement(EmailCardStat, { specificClass: "", statistic: statistics.sent }),
                React__default.createElement(EmailCardStat, { specificClass: "delivered", statistic: statistics.delivered }),
                React__default.createElement(EmailCardStat, { specificClass: "unique-opens", statistic: statistics.opens }),
                React__default.createElement(EmailCardStat, { specificClass: "unique-clicks", statistic: statistics.clicks }),
                React__default.createElement(EmailCardStat, { specificClass: "unsubscribes", statistic: statistics.unsubscribes }))),
            React__default.createElement("div", { className: "email-card" },
                React__default.createElement("div", { className: "email-card-count" },
                    React__default.createElement("p", null,
                        "Email ",
                        n)),
                React__default.createElement(EmailCardContent, { thumbnailUrl: thumbnailUrl, onContentEditClick: onContentEditClick }),
                React__default.createElement(EmailCardDetails, { details: details })),
            alertEl));
    };
...
var EmptyState = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('table-state', 'is-empty', className) }, attributes),
...
var FilterableList = /** @class */ (function (_super) {
    ...
    FilterableList.prototype.render = function () {
        ...
        return (React__default.createElement("section", __assign({ className: classNames('FilterableList', className) }, attributes),
...
var Footer = function (_a) {
    ...
    return (React__default.createElement("p", __assign({ className: classNames('small', 'is-center', className) }, attributes),
        icon && (React__default.createElement("span", null,
            React__default.createElement(Icon, { type: icon }),
            ' ')),
        header && React__default.createElement("strong", null, header + " "),
        children));
};

var FragmentLoader = function (_a) {
    var className = _a.className, attributes = __rest(_a, ["className"]);
    return (React__default.createElement("svg", __assign({ className: classNames('fragment-loader', className) }, attributes),
...
var Meter = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('meter-container', className) }, attributes),
...
var NumberedStep = function (_a) {
    ...
    return (React__default.createElement("li", __assign({}, attributes),
        React__default.createElement("h3", null, header),
        children));
};
var NumberedSteps = function (_a) {
    var children = _a.children, className = _a.className, attributes = __rest(_a, ["children", "className"]);
    return (React__default.createElement("ol", __assign({ className: classNames('numbered-steps', className) }, attributes), children));
};
...
var Progress = function (_a) {
    ...
    return (React__default.createElement("section", __assign({ className: classNames('progress-container', className, {
...
var ProgressStage = function (_a) {
    ...
    return (React__default.createElement("li", __assign({ className: classNames(className, {
            'is-done': done,
            'is-selected': selected,
        }) }, attributes),
...
var PageHeader = function (_a) {
    ...
    return React__default.createElement("header", __assign({}, attributes), children);
};
var PageHeading = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('content-header', className), style: headerStyle }, attributes),
...
var radioGroupMapper = function (props) {
    return map$3(props.children, function (child) {
        return child && (React__default.createElement(child.type, __assign({ key: child.props.value, name: props.name, onChange: props.onChange }, child.props)));
    });
};
...
var Radio = function (_a) {
    ...
    return (React__default.createElement("div", { className: "input-radio-wrap" },
        React__default.createElement("input", __assign({ checked: checked, defaultChecked: defaultChecked, disabled: disabled, id: id, name: name, onChange: onChange, type: "radio", value: value }, attributes)),
...
var SideModal = /** @class */ (function (_super) {
    ...
    SideModal.prototype.render = function () {
        ...
        return reactDom.createPortal(React__default.createElement(React.Fragment, null,
            React__default.createElement("div", __assign({ className: classNames('side-modal', className, { 'is-visible': isOpen }) }, attributes), children),
            React__default.createElement("div", { className: classNames('modal-mask', { 'is-visible': isOpen }), onClick: onClose })), modalContainer);
    };
...
var Slider = function (_a) {
    ...
    return (React__default.createElement("div", { className: "input-range-wrap" },
        React__default.createElement("input", __assign({ id: id, max: "100", min: "0", onChange: handleChange, type: "range", value: value }, attributes)),
...
var SegmentTerm = /** @class */ (function (_super) {
        ...
        get: function () {
            ...
            if (editing) {
                return (React__default.createElement(ButtonList, null,
                    showConfirm && (React__default.createElement(Button, { type: "secondary", small: true, onClick: onConfirm },
                        React__default.createElement(Icon, { type: "check-thin" }))),
                    onCancel && (React__default.createElement(Button, { type: "danger", small: true, onClick: onCancel },
    ...
    SegmentTerm.prototype.render = function () {
        ...
        return (React__default.createElement("div", __assign({ className: classNames('segment-term-wrap', className) }, attributes),
            ...
            React__default.createElement("div", { className: classNames('segment-term', {
                ...
                !editing && (React__default.createElement("p", null, label + " ",
                    React__default.createElement("strong", null, queryName))),
                this.termControls,
                renderAlert && renderAlert()),
            hasAddButton && (React__default.createElement(ButtonList, null,
...
var Tab = function (_a) {
    ...
    return (React__default.createElement("li", __assign({ className: classNames('tab', className, {
            'is-active': active,
...
var Tabs = function (_a) {
    ...
    return (React__default.createElement("ul", __assign({ className: classNames('tab-wrapper', className, {
            'is-centered': centered,
            'zero-border': zeroBorder,
        }) }, attributes), map$4(children, function (tab, index) {
...
var ToggleButtons = function (_a) {
    ...
    return (React__default.createElement("div", __assign({ className: classNames('btn-group', className) }, attributes), map$5(children, function (button, index) {
...
var Tooltip = function (_a) {
    ...
    return (React__default.createElement("span", __assign({ className: className, "data-tooltip": content, "data-tooltip-pos": direction, "data-tooltip-length": length }, attributes), children));
};
...
var HTMLTooltip = /** @class */ (function (_super) {
    ...
    function HTMLTooltip(props) {
        ...
        _this.handleHoverIn = function () {
            _this.setState({
                hovered: true,
                opened: true,
                tooltipHeight: _this.tooltipRef.offsetHeight,
            });
        };
    ...
    HTMLTooltip.prototype.render = function () {
        ...
        return (React__default.createElement("div", __assign({ style: __assign({ position: 'relative' }, style) }, attributes),
            React__default.createElement("div", { className: "tooltip-js-parent", onMouseEnter: this.handleHoverIn, onMouseLeave: this.handleHoverOut }, hoverTarget),
            React__default.createElement("div", { className: classNames("tooltip-js-content " + className, {
    ...
    var additionalItemText = (React__default.createElement("span", null,
        ...
        React__default.createElement("abbr", null,
            React__default.createElement("a", { href: link },
                ...
                " more"))));
    return (React__default.createElement("span", __assign({ className: className }, attributes),
...
exports.AccordionPanelSFC = AccordionPanelSFC;
exports.AccordionPanelTitle = AccordionPanelTitle;
exports.AccordionPanelDescription = AccordionPanelDescription;
exports.AccordionPanelIcon = AccordionPanelIcon;
...
exports.SplitCardSeparator = SplitCardSeparator;
