...
var CenterModal = /** @class */ (function (_super) {
    ...
    CenterModal.prototype.render = function () {
        ...
        return reactDom.createPortal(React__default.createElement(React.Fragment, null,
            ...
            React__default.createElement("div", { className: classNames('modal-mask', { 'is-visible': this.props.open }), onClick: this.props.onClose })), document.body);
    };
...
var lightStyle$1 = { color: 'white' };
var Icon$2 = function (_a) {
    var type = _a.type, className = _a.className, handleClick = _a.onClick, onDark = _a.onDark;
    return (React__default.createElement("i", { className: classNames('sg-icon', "sg-icon-" + type, (_b = {}, _b[className] = !!className, _b)), onClick: handleClick, style: onDark ? lightStyle$1 : null }));
    var _b;
};
Icon$2.defaultProps = {
    className: '',
        ...
        return reactDom.createPortal(React__default.createElement("div", { className: classNames('sg-modal', { 'is-visible': this.props.isOpen }) },
            React__default.createElement("div", { className: "conf-alert sg-modal-content" },
                React__default.createElement("h2", { className: classNames('conf-alert-header', { 'conf-alert-header-with-icon': !!this.props.iconType }) },
                    !!this.props.iconType &&
                        React__default.createElement(Icon$2, { type: this.props.iconType }),
                ...
                React__default.createElement("div", { className: "conf-alert-actions" }, evaluateRenderProp$1(this.props.renderActions)))), document.body);
    };
...
var SideModal = /** @class */ (function (_super) {
    ...
    SideModal.prototype.render = function () {
        return reactDom.createPortal(React__default.createElement(React.Fragment, null,
            ...
            React__default.createElement("div", { className: classNames('modal-mask', { 'is-visible': this.props.isOpen }), onClick: this.props.onClose })), document.body);
    };
